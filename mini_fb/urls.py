...
urlpatterns = [
  ...
  path(r'profile/create_status', views.CreateStatusMessageView.as_view(), name="create_status_form"), 
  ...
  path(r'register', views.CreateRegisterUserView.as_view(), name='register'),
